					...
					<div className=" font-sans">
						<div className="bg-white mt-4 rounded p-3">
							<div className="flex gap-2">
								<h1>Credit Score:</h1>
								<h1 className="font-bold text-teal-700">{tableData.score.toString()}</h1>
							</div>
							<div className="flex gap-2">
								<h1>Total Payments:</h1>
								<h1 className="font-bold">{tableData.total_payments.toString()}</h1>
							</div>
							<div className="flex gap-2">
								<h1>Total Defaults</h1>
								<h1 className="font-bold">{tableData.default_payments.toString()}</h1>
							</div>
							<div className="flex gap-2">
								<h1>Total Due : </h1>
							...
							<div className="flex gap-2">
								...
								<h1 className="font-bold">{tableData.allowed_balance.toString()}</h1>
							</div>
