					...
					<div className=' font-sans'>
						<div className='bg-white mt-4 rounded p-3'>
							<div className='flex gap-2'>
								<h1>Company Name:</h1>
								<h1 className='font-bold text-teal-700'>{shipmentData?.shipment_detail?.ship_from?.company_name
								}</h1>
							</div>
							<div className='flex gap-2'>
								<h1>Adress:</h1>
						...
						<div className='bg-white mt-4 rounded p-3'>
							<div className='flex gap-2'>
								<h1>Company Name:</h1>
								<h1 className='font-bold text-teal-700'>{shipmentData?.shipment_detail?.ship_to?.company_name || 'N/A'
								}</h1>
							</div>
							<div className='flex gap-2'>
								<h1>Adress:</h1>
